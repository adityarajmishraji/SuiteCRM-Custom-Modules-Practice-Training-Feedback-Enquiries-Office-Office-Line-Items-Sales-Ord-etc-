<?php
function customUNF_Sales_OrderLineItems($focus, $field, $value, $view)
{
    global $sugar_config, $locale, $app_list_strings, $mod_strings;

    $tableName = 'unf_sales_order';
    $moduleName = 'UNF_SalesOrder';

    $liTableName = 'unf_so_line_items';
    $liModuleName = 'UNF_SO_Line_Items';

    $relTable = 'unf_sales_order_unf_so_line_items_c';
    $relACol = 'unf_sales_order_unf_so_line_itemsunf_sales_order_ida';
    $relBCol = 'unf_sales_order_unf_so_line_itemsunf_so_line_items_idb';
