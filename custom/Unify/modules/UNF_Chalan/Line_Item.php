<?php
function customUNF_ChalanLineItems($focus, $field, $value, $view)
{
    global $sugar_config, $locale, $app_list_strings, $mod_strings;

    $tableName = 'unf_chalan';
    $moduleName = 'UNF_Chalan';

    $liTableName = 'unf_chalan_line_items';
    $liModuleName = 'UNF_Chalan_Line_Items';

    $relTable = 'unf_chalan_unf_chalan_line_items_c';
    $relACol = 'unf_chalan_unf_chalan_line_itemsunf_chalan_ida ';
    $relBCol = 'unf_chalan_unf_chalan_line_itemsunf_chalan_line_items_idb';
    ...
    if($view == 'EditView')
    {
        ...
        // $html .= '<input type="hidden" name="uom" id="uom" value="' . get_select_options_with_id($app_list_strings['uom'], '') . '">';
