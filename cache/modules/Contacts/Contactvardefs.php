<?php 
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    'unf_workshop_contacts_1unf_workshop_ida' => 
    array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Contact Reference',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'contact_reference_c',
      'vname' => 'LBL_CONTACT_REFERENCE',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      'comments' => 'Stores external reference ID for contact',
      'help' => 'leave blank, or add guidance if needed',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Contactscontact_reference_c',
