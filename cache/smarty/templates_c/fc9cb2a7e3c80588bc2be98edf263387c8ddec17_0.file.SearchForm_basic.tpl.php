<?php
/* Smarty version 4.5.3, created on 2025-09-05 09:30:19
  from 'C:\xampp\htdocs\Suitecrm\cache\themes\SuiteP\modules\UNF_Chalan\SearchForm_basic.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_68ba6053844512_95201239',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fc9cb2a7e3c80588bc2be98edf263387c8ddec17' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Suitecrm\\cache\\themes\\SuiteP\\modules\\UNF_Chalan\\SearchForm_basic.tpl',
      1 => 1757044819,
      2 => 'file',
    ),
  ),
...
function content_68ba6053844512_95201239 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label'=>'LBL_NAME','module'=>'UNF_Chalan'),$_smarty_tpl);?>
</label>
					</div>
...
' title=''  tabindex='-1'      accesskey='9'  >
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='chalan_date_basic' ><?php echo smarty_function_sugar_translate(array('label'=>'LBL_CHALAN_DATE','module'=>'UNF_Chalan'),$_smarty_tpl);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
<span class="dateTime">
<?php $_smarty_tpl->_assignInScope('date_value', $_smarty_tpl->tpl_vars['fields']->value['chalan_date_basic']['value']);?>
<input class="date_input" autocomplete="off" type="text" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['chalan_date_basic']['name'];?>
" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['chalan_date_basic']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['date_value']->value;?>
" title=''  tabindex='-1'    size="11" maxlength="10" >
    <button type="button" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['chalan_date_basic']['name'];?>
...
Calendar.setup ({
inputField : "<?php echo $_smarty_tpl->tpl_vars['fields']->value['chalan_date_basic']['name'];?>
",
form : "",
...
",
button : "<?php echo $_smarty_tpl->tpl_vars['fields']->value['chalan_date_basic']['name'];?>
_trigger",
singleClick : true,
...
>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='party_basic' ><?php echo smarty_function_sugar_translate(array('label'=>'LBL_PARTY','module'=>'UNF_Chalan'),$_smarty_tpl);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
<input type="text" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['party_basic']['name'];?>
"  class="sqsEnabled"  tabindex="-1"   id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['party_basic']['name'];?>
" size="" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['party_basic']['value'];?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['account_id_c_basic']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['account_id_c_basic']['value'];?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $_smarty_tpl->tpl_vars['fields']->value['party_basic']['name'];?>
...
" onclick='open_popup("<?php echo $_smarty_tpl->tpl_vars['fields']->value['party_basic']['module'];?>
", 600, 400, "", true, false, {"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"account_id_c_basic","name":"party_basic"}}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $_smarty_tpl->tpl_vars['fields']->value['party_basic']['name'];?>
"  tabindex="-1"   title="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CLEAR_BUTTON_TITLE'];?>
" class="button lastChild" onclick="this.form.<?php echo $_smarty_tpl->tpl_vars['fields']->value['party_basic']['name'];?>
.value = ''; this.form.<?php echo $_smarty_tpl->tpl_vars['fields']->value['account_id_c_basic']['name'];?>
