<?php
/* Smarty version 4.5.3, created on 2025-09-05 09:58:44
  from 'C:\xampp\htdocs\Suitecrm\cache\themes\SuiteP\modules\UNF_Enquiries\DetailView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_68ba66fc44cc91_98858597',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e358a23ca6d5d9331a92b85364a857bdd63c7ca2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Suitecrm\\cache\\themes\\SuiteP\\modules\\UNF_Enquiries\\DetailView.tpl',
      1 => 1757046524,
      2 => 'file',
    ),
  ),
...
function content_68ba66fc44cc91_98858597 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='UNF_Enquiries'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='UNF_Enquiries'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='UNF_Enquiries'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $_smarty_tpl->tpl_vars['APP']->value['NTC_DELETE_CONFIRMATION'];?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='UNF_Enquiries'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
echo smarty_function_sugar_translate(array('label'=>'LBL_NAME','module'=>'UNF_Enquiries'),$_smarty_tpl);
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="email">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="varchar" field="email" >
...
<span class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['email']['name'];?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="mobile">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="varchar" field="mobile" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['mobile']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>
...
<span class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['mobile']['name'];?>
"><?php echo $_smarty_tpl->tpl_vars['fields']->value['mobile']['value'];?>
</span>
<?php }?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="company_name">
...
<?php if (!$_smarty_tpl->tpl_vars['fields']->value['company_name']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>
...
<span class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['company_name']['name'];?>
"><?php echo $_smarty_tpl->tpl_vars['fields']->value['company_name']['value'];?>
</span>
<?php }?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="enquiry_for">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="enquiry_for" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['enquiry_for']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>



<?php if (is_string($_smarty_tpl->tpl_vars['fields']->value['enquiry_for']['options'])) {?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['enquiry_for']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['enquiry_for']['options'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['enquiry_for']['options'];?>

<?php } else { ?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['enquiry_for']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['enquiry_for']['value'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['enquiry_for']['options'][$_smarty_tpl->tpl_vars['fields']->value['enquiry_for']['value']];?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="text" field="address" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['address']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<span class="sugar_field" id="<?php echo nl2br((string) url2html(smarty_modifier_escape($_smarty_tpl->tpl_vars['fields']->value['address']['name'],'html')), (bool) 1);?>
"><?php echo nl2br((string) url2html(smarty_modifier_escape(smarty_modifier_escape($_smarty_tpl->tpl_vars['fields']->value['address']['value'],'html'),'html_entity_decode')), (bool) 1);?>
</span>
<?php }?>
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_DATE_ENTERED','module'=>'UNF_Enquiries'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
</div>
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_DATE_MODIFIED','module'=>'UNF_Enquiries'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
</div>
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_CREATED','module'=>'UNF_Enquiries'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
</div>
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_MODIFIED_NAME','module'=>'UNF_Enquiries'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
</div>
