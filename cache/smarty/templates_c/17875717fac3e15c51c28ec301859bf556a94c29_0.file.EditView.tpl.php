...
/* Smarty version 4.5.3, created on 2025-09-05 09:14:11
  from 'C:\xampp\htdocs\Suitecrm\cache\themes\SuiteP\modules\UNF_Sales_Order\EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_68ba5c8bc67be4_52798373',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '17875717fac3e15c51c28ec301859bf556a94c29' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Suitecrm\\cache\\themes\\SuiteP\\modules\\UNF_Sales_Order\\EditView.tpl',
      1 => 1757043851,
      2 => 'file',
    ),
  ),
...
function content_68ba5c8bc67be4_52798373 (Smarty_Internal_Template $_smarty_tpl) {
...
" accessKey="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CANCEL_BUTTON_KEY'];?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=UNF_Sales_Order'); return false;" type="button" name="button" value="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CANCEL_BUTTON_LABEL'];?>
...
<span class="dateTime">
<?php $_smarty_tpl->_assignInScope('date_value', $_smarty_tpl->tpl_vars['fields']->value['s_o_date']['value']);?>
<input class="date_input" autocomplete="off" type="text" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['s_o_date']['name'];?>
" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['s_o_date']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['date_value']->value;?>
" title=''  tabindex='0'    size="11" maxlength="10" >
<button type="button" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['s_o_date']['name'];?>
...
Calendar.setup ({
inputField : "<?php echo $_smarty_tpl->tpl_vars['fields']->value['s_o_date']['name'];?>
",
form : "EditView",
...
",
button : "<?php echo $_smarty_tpl->tpl_vars['fields']->value['s_o_date']['name'];?>
_trigger",
singleClick : true,
...
<input type="text" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['name'];?>
" class="sqsEnabled" tabindex="0" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['name'];?>
" size="" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['value'];?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['id_name'];?>
" 
id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['id_name'];?>
" 
value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['account_id_c']['value'];?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['name'];?>
" id="btn_<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['name'];?>
...
"
onclick='open_popup(
"<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['module'];?>
", 
600, 
400, 
"", 
true, 
false, 
{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"account_id_c","name":"customer"}}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['name'];?>
" id="btn_clr_<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['name'];?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label'=>"LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE"),$_smarty_tpl);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['name'];?>
', '<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['id_name'];?>
...
_<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer']['name'];?>
']) != 'undefined'",
		enableQS
);
<?php echo '</script'; ?>
...
<a class="" role="button" data-toggle="collapse-edit" aria-expanded="false">
<div class="col-xs-10 col-sm-11 col-md-11">
<?php echo smarty_function_sugar_translate(array('label'=>'LBL_EDITVIEW_PANEL1','module'=>'UNF_Sales_Order'),$_smarty_tpl);?>
...
ob_start();
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_LINE_ITEMS','module'=>'UNF_Sales_Order'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
...
<?php echo smarty_function_sugar_run_helper(array('include'=>"custom/Unify/modules/UNF_SalesOrder/Line_Item.php",'func'=>"customUNF_Sales_OrderLineItems",'bean'=>$_smarty_tpl->tpl_vars['bean']->value,'field'=>"line_items",'value'=>$_smarty_tpl->tpl_vars['fields']->value['line_items']['value'],'displayType'=>"EditView"),$_smarty_tpl);?>
...
<?php echo '<script'; ?>
 type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_NAME','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_MODIFIED','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_MODIFIED_NAME','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CREATED','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'created_by_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CREATED','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'description', 'text', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DESCRIPTION','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'deleted', 'bool', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DELETED','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_ID','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_NAME','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 's_o_date', 'date', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_S_O_DATE','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'total_amount', 'decimal', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_TOTAL_AMOUNT','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'total_quantity', 'decimal', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_TOTAL_QUANTITY','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'account_id_c', 'id', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CUSTOMER_ACCOUNT_ID','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'customer', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CUSTOMER','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'line_items', 'function', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_LINE_ITEMS','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'<?php echo smarty_function_sugar_translate(array('label'=>'ERR_SQS_NO_MATCH_FIELD','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
: <?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
', 'assigned_user_id' );
addToValidateBinaryDependency('EditView', 'customer', 'alpha', false,'<?php echo smarty_function_sugar_translate(array('label'=>'ERR_SQS_NO_MATCH_FIELD','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
: <?php echo smarty_function_sugar_translate(array('label'=>'LBL_CUSTOMER','module'=>'UNF_Sales_Order','for_js'=>true),$_smarty_tpl);?>
', 'account_id_c' );
<?php echo '</script'; ?>
><?php echo '<script'; ?>
