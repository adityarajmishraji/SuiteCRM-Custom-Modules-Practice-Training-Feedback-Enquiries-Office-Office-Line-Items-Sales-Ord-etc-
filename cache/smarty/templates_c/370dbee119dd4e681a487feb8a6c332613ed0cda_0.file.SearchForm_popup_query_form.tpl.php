<?php
/* Smarty version 4.5.3, created on 2025-09-05 10:56:29
  from 'C:\xampp\htdocs\Suitecrm\cache\themes\SuiteP\modules\UNF_Sales_Order\SearchForm_popup_query_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_68ba74856aac02_11436861',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '370dbee119dd4e681a487feb8a6c332613ed0cda' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Suitecrm\\cache\\themes\\SuiteP\\modules\\UNF_Sales_Order\\SearchForm_popup_query_form.tpl',
      1 => 1757049988,
      2 => 'file',
    ),
  ),
...
function content_68ba74856aac02_11436861 (Smarty_Internal_Template $_smarty_tpl) {
...
", 600, 400, "", true, false, {"call_back_function":"set_return","form_name":"popup_query_form","field_to_name_array":{"id":"account_id_c_advanced","name":"customer_advanced"}}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $_smarty_tpl->tpl_vars['fields']->value['customer_advanced']['name'];?>
...
' title='' tabindex='-1' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_name_advanced'><?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_NAME','module'=>'UNF_Sales_Order'),$_smarty_tpl);?>
</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['assigned_user_name_advanced']['name'];?>
"  class="sqsEnabled"  tabindex="-1"   id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['assigned_user_name_advanced']['name'];?>
" size="" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['assigned_user_name_advanced']['value'];?>
" title='' autocomplete="off"  >
<input type="hidden" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['assigned_user_id_advanced']['name'];?>
" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['assigned_user_id_advanced']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['assigned_user_id_advanced']['value'];?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $_smarty_tpl->tpl_vars['fields']->value['assigned_user_name_advanced']['name'];?>
"  tabindex="-1"   title="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_SELECT_BUTTON_TITLE'];?>
" class="button firstChild" value="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_SELECT_BUTTON_LABEL'];?>
" onclick='open_popup("<?php echo $_smarty_tpl->tpl_vars['fields']->value['assigned_user_name_advanced']['module'];?>
", 600, 400, "", true, false, {"call_back_function":"set_return","form_name":"popup_query_form","field_to_name_array":{"id":"assigned_user_id_advanced","user_name":"assigned_user_name_advanced"}}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $_smarty_tpl->tpl_vars['fields']->value['assigned_user_name_advanced']['name'];?>
"  tabindex="-1"   title="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CLEAR_BUTTON_TITLE'];?>
" class="button lastChild" onclick="this.form.<?php echo $_smarty_tpl->tpl_vars['fields']->value['assigned_user_name_advanced']['name'];?>
.value = ''; this.form.<?php echo $_smarty_tpl->tpl_vars['fields']->value['assigned_user_id_advanced']['name'];?>
.value = '';" value="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CLEAR_BUTTON_LABEL'];?>
"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
...
<input class="date_input" autocomplete="off" type="text" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_entered_advanced']['name'];?>
" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_entered_advanced']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['date_value']->value;?>
" title=''  tabindex='-1'    size="11" maxlength="10" >
    <button type="button" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_entered_advanced']['name'];?>
_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_ENTER_DATE'];?>
"></span></button>
</span>
<?php echo '<script'; ?>
 type="text/javascript">
Calendar.setup ({
inputField : "<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_entered_advanced']['name'];?>
",
form : "popup_query_form",
ifFormat : "<?php echo $_smarty_tpl->tpl_vars['CALENDAR_FORMAT']->value;?>
",
daFormat : "<?php echo $_smarty_tpl->tpl_vars['CALENDAR_FORMAT']->value;?>
",
button : "<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_entered_advanced']['name'];?>
_trigger",
singleClick : true,
dateStr : "<?php echo $_smarty_tpl->tpl_vars['date_value']->value;?>
",
...
>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_modified_advanced'><?php echo smarty_function_sugar_translate(array('label'=>'LBL_DATE_MODIFIED','module'=>'UNF_Sales_Order'),$_smarty_tpl);?>
</label>
                            </div>
            <div class="form-item">
                                
<span class="dateTime">
<?php $_smarty_tpl->_assignInScope('date_value', $_smarty_tpl->tpl_vars['fields']->value['date_modified_advanced']['value']);?>
<input class="date_input" autocomplete="off" type="text" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_modified_advanced']['name'];?>
" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_modified_advanced']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['date_value']->value;?>
" title=''  tabindex='-1'    size="11" maxlength="10" >
    <button type="button" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_modified_advanced']['name'];?>
_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_ENTER_DATE'];?>
"></span></button>
</span>
<?php echo '<script'; ?>
 type="text/javascript">
Calendar.setup ({
inputField : "<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_modified_advanced']['name'];?>
",
form : "popup_query_form",
ifFormat : "<?php echo $_smarty_tpl->tpl_vars['CALENDAR_FORMAT']->value;?>
",
daFormat : "<?php echo $_smarty_tpl->tpl_vars['CALENDAR_FORMAT']->value;?>
",
button : "<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_modified_advanced']['name'];?>
_trigger",
singleClick : true,
dateStr : "<?php echo $_smarty_tpl->tpl_vars['date_value']->value;?>
",
