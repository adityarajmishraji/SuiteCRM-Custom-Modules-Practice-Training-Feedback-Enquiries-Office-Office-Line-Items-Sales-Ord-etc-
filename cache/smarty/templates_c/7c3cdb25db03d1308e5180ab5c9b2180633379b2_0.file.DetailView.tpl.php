<?php
/* Smarty version 4.5.3, created on 2025-09-04 17:40:29
  from 'C:\xampp\htdocs\Suitecrm\cache\themes\SuiteP\modules\UNF_registration\DetailView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_68b981b5e06c46_27141872',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7c3cdb25db03d1308e5180ab5c9b2180633379b2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Suitecrm\\cache\\themes\\SuiteP\\modules\\UNF_registration\\DetailView.tpl',
      1 => 1756987829,
      2 => 'file',
    ),
  ),
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='UNF_registration'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='UNF_registration'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='UNF_registration'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $_smarty_tpl->tpl_vars['APP']->value['NTC_DELETE_CONFIRMATION'];?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='UNF_registration'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_NAME','module'=>'UNF_registration'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
</div>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="phone_number">
...
<div class="col-xs-12 col-sm-8 detail-view-field phone" type="phone" field="phone_number" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['phone_number']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<?php if (!empty($_smarty_tpl->tpl_vars['fields']->value['phone_number']['value'])) {
$_smarty_tpl->_assignInScope('phone_value', $_smarty_tpl->tpl_vars['fields']->value['phone_number']['value']);
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="gender">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="gender" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['gender']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>



<?php if (is_string($_smarty_tpl->tpl_vars['fields']->value['gender']['options'])) {?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['gender']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['gender']['options'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['gender']['options'];?>

<?php } else { ?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['gender']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['gender']['value'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['gender']['options'][$_smarty_tpl->tpl_vars['fields']->value['gender']['value']];?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="date_of_birth">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="date" field="date_of_birth" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['date_of_birth']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>
...
if (strlen($_smarty_tpl->tpl_vars['fields']->value['date_of_birth']['value']) <= 0) {
$_smarty_tpl->_assignInScope('value', $_smarty_tpl->tpl_vars['fields']->value['date_of_birth']['default_value']);
} else {
$_smarty_tpl->_assignInScope('value', $_smarty_tpl->tpl_vars['fields']->value['date_of_birth']['value']);
}
}?>
<span class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['date_of_birth']['name'];?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="city">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="varchar" field="city" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['city']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>
...
<span class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['city']['name'];?>
"><?php echo $_smarty_tpl->tpl_vars['fields']->value['city']['value'];?>
</span>
<?php }?>
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_CREATED','module'=>'UNF_registration'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
</div>
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_DATE_ENTERED','module'=>'UNF_registration'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
</div>
