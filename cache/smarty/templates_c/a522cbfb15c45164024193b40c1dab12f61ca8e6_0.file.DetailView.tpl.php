<?php
/* Smarty version 4.5.3, created on 2025-09-05 09:18:57
  from 'C:\xampp\htdocs\Suitecrm\cache\themes\SuiteP\modules\AOS_Products\DetailView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_68ba5da9ae7282_87661672',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a522cbfb15c45164024193b40c1dab12f61ca8e6' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Suitecrm\\cache\\themes\\SuiteP\\modules\\AOS_Products\\DetailView.tpl',
      1 => 1757044137,
      2 => 'file',
    ),
  ),
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='AOS_Products'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='AOS_Products'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='AOS_Products'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $_smarty_tpl->tpl_vars['APP']->value['NTC_DELETE_CONFIRMATION'];?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="part_number">
...
<?php if (!$_smarty_tpl->tpl_vars['fields']->value['part_number']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>
...
<span class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['part_number']['name'];?>
"><?php echo $_smarty_tpl->tpl_vars['fields']->value['part_number']['value'];?>
</span>
<?php }?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="aos_product_category_name">
...
<?php if (!$_smarty_tpl->tpl_vars['fields']->value['aos_product_category_name']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<?php if (!empty($_smarty_tpl->tpl_vars['fields']->value['aos_product_category_id']['value'])) {
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, 'default', "detail_url", null);?>index.php?module=AOS_Product_Categories&action=DetailView&record=<?php echo $_smarty_tpl->tpl_vars['fields']->value['aos_product_category_id']['value'];
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url'=>$_smarty_tpl->tpl_vars['detail_url']->value),$_smarty_tpl);?>
"><?php }?>
<span id="aos_product_category_id" class="sugar_field" data-id-value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['aos_product_category_id']['value'];?>
"><?php echo $_smarty_tpl->tpl_vars['fields']->value['aos_product_category_name']['value'];?>
</span>
<?php if (!empty($_smarty_tpl->tpl_vars['fields']->value['aos_product_category_id']['value'])) {?></a><?php }
}?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="currency_id">
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="uom_c">
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_UOM','module'=>'AOS_Products'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
</div>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="uom_c" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['uom_c']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>



<?php if (is_string($_smarty_tpl->tpl_vars['fields']->value['uom_c']['options'])) {?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['uom_c']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['uom_c']['options'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['uom_c']['options'];?>

<?php } else { ?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['uom_c']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['uom_c']['value'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['uom_c']['options'][$_smarty_tpl->tpl_vars['fields']->value['uom_c']['value']];?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="cost">
...
<?php if (!$_smarty_tpl->tpl_vars['fields']->value['cost']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<span id='<?php echo $_smarty_tpl->tpl_vars['fields']->value['cost']['name'];?>
'>
<?php echo smarty_function_sugar_number_format(array('var'=>$_smarty_tpl->tpl_vars['fields']->value['cost']['value']),$_smarty_tpl);?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="price">
...
<?php if (!$_smarty_tpl->tpl_vars['fields']->value['price']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<span id='<?php echo $_smarty_tpl->tpl_vars['fields']->value['price']['name'];?>
'>
<?php echo smarty_function_sugar_number_format(array('var'=>$_smarty_tpl->tpl_vars['fields']->value['price']['value']),$_smarty_tpl);?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="contact">
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_CONTACT','module'=>'AOS_Products'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
</div>
...
<?php if (!$_smarty_tpl->tpl_vars['fields']->value['contact']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<?php if (!empty($_smarty_tpl->tpl_vars['fields']->value['contact_id']['value'])) {
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, 'default', "detail_url", null);?>index.php?module=Contacts&action=DetailView&record=<?php echo $_smarty_tpl->tpl_vars['fields']->value['contact_id']['value'];
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url'=>$_smarty_tpl->tpl_vars['detail_url']->value),$_smarty_tpl);?>
"><?php }?>
<span id="contact_id" class="sugar_field" data-id-value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['contact_id']['value'];?>
"><?php echo $_smarty_tpl->tpl_vars['fields']->value['contact']['value'];?>
</span>
<?php if (!empty($_smarty_tpl->tpl_vars['fields']->value['contact_id']['value'])) {?></a><?php }
}?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="url">
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_URL','module'=>'AOS_Products'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
</div>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="url" field="url" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['url']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, 'getLink', 'link', null);
echo $_smarty_tpl->tpl_vars['fields']->value['url']['value'];
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
...
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
<span class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['url']['name'];?>
">
...
<div class="col-xs-12 col-sm-12 detail-view-row-item" data-field="product_image">
...
<div class="col-xs-12 col-sm-10 detail-view-field" type="varchar" field="product_image" colspan='3'>

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['product_image']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>

<span id="product_image" class="sugar_field"><img src="<?php echo $_smarty_tpl->tpl_vars['fields']->value['product_image']['value'];?>
"/></span>
<?php }?>
