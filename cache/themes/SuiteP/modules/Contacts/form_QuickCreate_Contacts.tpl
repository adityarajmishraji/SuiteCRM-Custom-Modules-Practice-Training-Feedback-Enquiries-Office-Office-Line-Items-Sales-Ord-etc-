...
addToValidate('form_QuickCreate_Contacts', 'unf_workshop_contacts_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_UNF_WORKSHOP_CONTACTS_1_FROM_UNF_WORKSHOP_TITLE' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'contact_reference_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CONTACT_REFERENCE' module='Contacts' for_js=true}{literal}' );
