...
<input type='text' name='{$fields.first_name_advanced.name}'
    ...
    maxlength='100'        value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
...
<input type="text" name="{$fields.campaign_name_advanced.name}"  class= "sqsEnabled sqsNoAutofill"   tabindex="-1"   id="{$fields.campaign_name_advanced.name}" size="30" value="{$fields.campaign_name_advanced.value}" title='' autocomplete="off"  >
