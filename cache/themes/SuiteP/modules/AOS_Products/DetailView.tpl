...
{capture name="label" assign="label"}{sugar_translate label='LBL_UOM' module='AOS_Products'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name=getLink assign=link}{$fields.url.value}{/capture}
{if !empty($link)}
{capture name=getStart assign=linkStart}{$link|substr:0:7}{/capture}
<span class="sugar_field" id="{$fields.url.name}">
