...
<input type='text' name='{$fields.part_number_advanced.name}'
    ...
    maxlength='25'        value='{$value}' title=''  tabindex='-1'      >
...
<input type='text' name='range_{$id}' id='range_{$id}' style='width:75px !important;' size='20' 
    ...
    value='{if empty($smarty.request.range_cost_advanced) && !empty($smarty.request.cost_advanced)}{$smarty.request.cost_advanced}{else}{$smarty.request.range_cost_advanced}{/if}' tabindex='-1' >
</div>
...
<input type='text' name='start_range_{$id}' 
    ...
    value='{$smarty.request.start_range_cost_advanced }' tabindex='-1'>
{$APP.LBL_AND}
<input type='text' name='end_range_{$id}' 
    id='end_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.end_range_cost_advanced }' tabindex='-1'>    
</div> 
</span>
                            </div>
        </div>
...
<input type='text' name='range_{$id}' id='range_{$id}' style='width:75px !important;' size='20' 
    ...
    value='{if empty($smarty.request.range_price_advanced) && !empty($smarty.request.price_advanced)}{$smarty.request.price_advanced}{else}{$smarty.request.range_price_advanced}{/if}' tabindex='-1' >
</div>
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
<input type='text' name='start_range_{$id}' 
    id='start_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.start_range_price_advanced }' tabindex='-1'>
{$APP.LBL_AND}
<input type='text' name='end_range_{$id}' 
    id='end_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.end_range_price_advanced }' tabindex='-1'>    
</div> 
</span>
                            </div>
        </div>
