...
<select name="{$fields.uom_c.name}"
id="{$fields.uom_c.name}"
title=''              
>
{if isset($fields.uom_c.value)}
{html_options options=$fields.uom_c.options selected=$fields.uom_c.value}
{else}
{html_options options=$fields.uom_c.options selected=$fields.uom_c.default}
{/if}
</select>
</div>
...
<input type='text' name='{$fields.url.name}' id='{$fields.url.name}' size='30' 
maxlength='255' value='{$fields.url.value}' title='' tabindex='0'  >
{else}
<input type='text' name='{$fields.url.name}' id='{$fields.url.name}' size='30' 
...
addToValidate('EditView', 'url', 'url', false,'{/literal}{sugar_translate label='LBL_URL' module='AOS_Products' for_js=true}{literal}' );
...
addToValidate('EditView', 'uom_c', 'enum', false,'{/literal}{sugar_translate label='LBL_UOM' module='AOS_Products' for_js=true}{literal}' );
