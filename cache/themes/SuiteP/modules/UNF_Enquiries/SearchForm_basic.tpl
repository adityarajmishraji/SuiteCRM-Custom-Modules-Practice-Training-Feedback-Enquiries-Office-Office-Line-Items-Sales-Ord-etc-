...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='name_basic'> {sugar_translate label='LBL_NAME' module='UNF_Enquiries'}</label>
					</div>
...
<input type='text' name='{$fields.name_basic.name}'
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='status_basic' >{sugar_translate label='LBL_STATUS' module='UNF_Enquiries'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
...
{html_options id='status_basic' name='status_basic[]' options=$fields.status_basic.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.status_basic.value}
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='enquiry_for_basic' >{sugar_translate label='LBL_ENQUIRY_FOR' module='UNF_Enquiries'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{html_options id='enquiry_for_basic' name='enquiry_for_basic[]' options=$fields.enquiry_for_basic.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.enquiry_for_basic.value}
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='date_entered_basic' >{sugar_translate label='LBL_DATE_ENTERED' module='UNF_Enquiries'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
...
{rdelim}
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='UNF_Enquiries'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
