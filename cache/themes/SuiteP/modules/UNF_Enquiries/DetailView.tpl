...
<div class="buttons">
{if $bean->aclAccess("edit")}<input title="{$APP.LBL_EDIT_BUTTON_TITLE}" accessKey="{$APP.LBL_EDIT_BUTTON_KEY}" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='UNF_Enquiries'; _form.return_action.value='DetailView'; _form.return_id.value='{$id}'; _form.action.value='EditView';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Edit" id="edit_button" value="{$APP.LBL_EDIT_BUTTON_LABEL}">{/if} 
{if $bean->aclAccess("edit")}<input title="{$APP.LBL_DUPLICATE_BUTTON_TITLE}" accessKey="{$APP.LBL_DUPLICATE_BUTTON_KEY}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='UNF_Enquiries'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='{$id}';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Duplicate" value="{$APP.LBL_DUPLICATE_BUTTON_LABEL}" id="duplicate_button">{/if} 
{if $bean->aclAccess("delete")}<input title="{$APP.LBL_DELETE_BUTTON_TITLE}" accessKey="{$APP.LBL_DELETE_BUTTON_KEY}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='UNF_Enquiries'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('{$APP.NTC_DELETE_CONFIRMATION}')) SUGAR.ajaxUI.submitForm(_form); return false;" type="submit" name="Delete" value="{$APP.LBL_DELETE_BUTTON_LABEL}" id="delete_button">{/if} 
{if $bean->aclAccess("edit") && $bean->aclAccess("delete")}<input title="{$APP.LBL_DUP_MERGE}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='UNF_Enquiries'; _form.return_action.value='DetailView'; _form.return_id.value='{$id}'; _form.action.value='Step1'; _form.module.value='MergeRecords';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Merge" value="{$APP.LBL_DUP_MERGE}" id="merge_duplicate_button">{/if} 
{if $bean->aclAccess("detail")}{if !empty($fields.id.value) && $isAuditEnabled}<input id="btn_view_change_log" title="{$APP.LNK_VIEW_CHANGE_LOG}" class="button" onclick='open_popup("Audit", "600", "400", "&record={$fields.id.value}&module_name=UNF_Enquiries", true, false,  {ldelim} "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] {rdelim} ); return false;' type="button" value="{$APP.LNK_VIEW_CHANGE_LOG}">{/if}{/if}
</div>
{/if}
</form>
</div>
...
{sugar_translate label='DEFAULT' module='UNF_Enquiries'}
</a>
...
<li>{if $bean->aclAccess("detail")}{if !empty($fields.id.value) && $isAuditEnabled}<input id="btn_view_change_log" title="{$APP.LNK_VIEW_CHANGE_LOG}" class="button" onclick='open_popup("Audit", "600", "400", "&record={$fields.id.value}&module_name=UNF_Enquiries", true, false,  {ldelim} "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] {rdelim} ); return false;' type="button" value="{$APP.LNK_VIEW_CHANGE_LOG}">{/if}{/if}</li>
</ul>
</li>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME' module='UNF_Enquiries'}{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_FIRST_NAME' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_LAST_NAME' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_EMAIL' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MOBILE' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_COMPANY_NAME' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ENQUIRY_FOR' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.enquiry_for.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.enquiry_for.options)}
<input type="hidden" class="sugar_field" id="{$fields.enquiry_for.name}" value="{ $fields.enquiry_for.options }">
{ $fields.enquiry_for.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.enquiry_for.name}" value="{ $fields.enquiry_for.value }">
{ $fields.enquiry_for.options[$fields.enquiry_for.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ADDRESS' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
<span class="sugar_field" id="{$fields.address.name|escape:'html'|url2html|nl2br}">{$fields.address.value|escape:'html'|escape:'html_entity_decode'|url2html|nl2br}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_STATUS' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_ENTERED' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_MODIFIED' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CREATED' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MODIFIED_NAME' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='UNF_Enquiries'}{/capture}
{$label|strip_semicolon}:
</div>
