...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='UNF_Sales_Order'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.name_advanced.name}'
    ...
    maxlength='255'        value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='s_o_date_advanced'>{sugar_translate label='LBL_S_O_DATE' module='UNF_Sales_Order'}</label>
                            </div>
            <div class="form-item">
                                
<span class="dateTime">
{assign var=date_value value=$fields.s_o_date_advanced.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.s_o_date_advanced.name}" id="{$fields.s_o_date_advanced.name}" value="{$date_value}" title=''  tabindex='-1'    size="11" maxlength="10" >
    <button type="button" id="{$fields.s_o_date_advanced.name}_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.s_o_date_advanced.name}",
form : "popup_query_form",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.s_o_date_advanced.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='customer_advanced'>{sugar_translate label='LBL_CUSTOMER' module='UNF_Sales_Order'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.customer_advanced.name}"  class="sqsEnabled"  tabindex="-1"   id="{$fields.customer_advanced.name}" size="" value="{$fields.customer_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.account_id_c_advanced.name}" value="{$fields.account_id_c_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.customer_advanced.name}"  tabindex="-1"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.customer_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"popup_query_form","field_to_name_array":{"id":"account_id_c_advanced","name":"customer_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.customer_advanced.name}"  tabindex="-1"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.customer_advanced.name}.value = ''; this.form.{$fields.account_id_c_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='description_advanced'>{sugar_translate label='LBL_DESCRIPTION' module='UNF_Sales_Order'}</label>
                            </div>
            <div class="form-item">
...
{literal}{/literal}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='total_quantity_advanced'>{sugar_translate label='LBL_TOTAL_QUANTITY' module='UNF_Sales_Order'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.total_quantity_advanced.value) <= 0}
{assign var="value" value=$fields.total_quantity_advanced.default_value }
{else}
{assign var="value" value=$fields.total_quantity_advanced.value }
{/if}  
<input type='text' name='{$fields.total_quantity_advanced.name}' 
    id='{$fields.total_quantity_advanced.name}' size='30' 
    ...
    value='{$value}' title='' tabindex='-1' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='total_amount_advanced'>{sugar_translate label='LBL_TOTAL_AMOUNT' module='UNF_Sales_Order'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.total_amount_advanced.name}' 
    ...
    value='{$value}' title='' tabindex='-1' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_name_advanced'>{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='UNF_Sales_Order'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.assigned_user_name_advanced.name}"  class="sqsEnabled"  tabindex="-1"   id="{$fields.assigned_user_name_advanced.name}" size="" value="{$fields.assigned_user_name_advanced.value}" title='' autocomplete="off"  >
...
<button type="button" name="btn_{$fields.assigned_user_name_advanced.name}"  tabindex="-1"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.assigned_user_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"popup_query_form","field_to_name_array":{"id":"assigned_user_id_advanced","user_name":"assigned_user_name_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.assigned_user_name_advanced.name}"  tabindex="-1"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.assigned_user_name_advanced.name}.value = ''; this.form.{$fields.assigned_user_id_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='UNF_Sales_Order'}</label>
                            </div>
            <div class="form-item">
                                
<span class="dateTime">
{assign var=date_value value=$fields.date_entered_advanced.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.date_entered_advanced.name}" id="{$fields.date_entered_advanced.name}" value="{$date_value}" title=''  tabindex='-1'    size="11" maxlength="10" >
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_modified_advanced'>{sugar_translate label='LBL_DATE_MODIFIED' module='UNF_Sales_Order'}</label>
                            </div>
            <div class="form-item">
                                
<span class="dateTime">
{assign var=date_value value=$fields.date_modified_advanced.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.date_modified_advanced.name}" id="{$fields.date_modified_advanced.name}" value="{$date_value}" title=''  tabindex='-1'    size="11" maxlength="10" >
    <button type="button" id="{$fields.date_modified_advanced.name}_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
